...
public enum TokenType {
    ...
    public static Map<String, TokenType> SCENARIO_KEYWORDS = new ImmutableMap.Builder<String, TokenType>()
                                                                     .put("Background", BACKGROUND_KEYWORD)
                                                                     .put("Scenario", SCENARIO_KEYWORD)
                                                                     .put("Scenario Outline", SCENARIO_OUTLINE_KEYWORD).build();

    public static Map<String, TokenType> STEP_KEYWORDS = new ImmutableMap.Builder<String, TokenType>()
